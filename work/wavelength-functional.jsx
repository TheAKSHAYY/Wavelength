      ...
      <main className="main">
        ...
        <div className="grid-2">
          <div className="card" style={{ padding: 22 }}>
            <SectionHeader eyebrow="Trend Discovery Engine (live web search)" title="Trending right now" action="Refresh" onAction={refreshTrends} loading={loadingTrends} />
            {trends.length === 0 && !loadingTrends && <EmptyState text="No trends yet \u2014 click Refresh to search the web live." />}
            {loadingTrends && <EmptyState text="Searching the web for current trends..." />}
            {trends.map((t) => {
        ...
        <div className="grid-2">
          <div className="card" style={{ padding: 22 }}>
            <SectionHeader eyebrow="Competitor Intelligence (live web search)" title="Competitor activity" />
            <div style={{ display: "flex", gap: 8, marginBottom: 14 }}>
        ...
        <div className="card" style={{ padding: 22, marginBottom: 22 }}>
          <SectionHeader eyebrow="Keyword Research (live web search)" title="Search demand for your niche" />
